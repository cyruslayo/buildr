    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="space-y-4">
        ...
        <div className="relative">
          ...
          {/* Magnitude Confirmation: Prevents "flash of zero" and provides clear UX */}
          <div
            className="absolute -bottom-4 left-0 right-0 flex justify-center h-6 overflow-hidden"
            aria-live="polite"
          >
            <AnimatePresence mode="popLayout">
              {propertyData.price && propertyData.price >= 1000 && (
                <motion.span
                  ...
                  className="text-xs font-bold text-emerald-600 bg-emerald-50 px-3 py-1 rounded-full shadow-sm border border-emerald-100"
                >
