    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="space-y-4">
        ...
        <div className="relative">
          ...
          />
          <div
            className="absolute left-0 right-0 -bottom-2 flex justify-center h-6"
            aria-live="polite"
          >
      ...
      <div className="text-center text-xs text-muted-foreground/50 uppercase tracking-widest mt-6">
