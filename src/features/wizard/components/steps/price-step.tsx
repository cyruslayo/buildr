...
export function PriceStep() {
  ...
  const shorthandValue = propertyData.price ? formatCurrencyShorthand(Number(propertyData.price)) : '';
  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="space-y-4">
        ...
        <div className="h-8 flex justify-center items-center" aria-live="polite">
          <AnimatePresence mode="wait">
            {propertyData.price && Number(propertyData.price) >= 1000 && (
              <motion.span
                key={shorthandValue}
