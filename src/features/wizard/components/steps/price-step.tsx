    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="space-y-4">
        ...
        <div className="relative group">
          ...
          {/* Real-time magnitude confirmation - Lagos Luxury polish */}
          <div
            ...
            <AnimatePresence mode="popLayout">
              {propertyData.price && propertyData.price >= 1000 ? (
                <motion.span
                  ...
                  className="text-emerald-600 font-bold tracking-tight bg-emerald-50 px-4 py-1 rounded-full shadow-sm border border-emerald-100 text-sm"
                >
