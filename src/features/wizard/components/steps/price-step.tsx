...
export function PriceStep() {
  ...
  const shorthand = propertyData.price ? formatCurrencyShorthand(propertyData.price) : '';
    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="space-y-4">
        ...
        <div className="relative">
          ...
          <div
            className="absolute -bottom-2 left-0 right-0 flex justify-center h-6"
            aria-live="polite"
          >
            <AnimatePresence mode="popLayout">
              {propertyData.price && propertyData.price >= 1000 && (
                <motion.span
                  ...
                  exit={{ opacity: 0, y: -10 }}
                  className="text-sm font-bold text-emerald-600 tracking-wide"
                >
                  {shorthand}
                </motion.span>
              )}
      ...
      <div className="text-center text-xs text-muted-foreground/50 uppercase tracking-widest mt-8">
