    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="space-y-4">
        ...
        <div className="relative">
          ...
          <div className="absolute -bottom-2 left-0 right-0 flex justify-center h-6 overflow-hidden" aria-live="polite">
            <AnimatePresence>
              {propertyData.price > 0 && (
                <motion.span
                  ...
                  className="text-sm font-medium text-primary/60 italic"
                >
