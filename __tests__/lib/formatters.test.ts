...
describe('Formatters', () => {
  ...
  describe('formatCurrencyShorthand', () => {
    it('formats thousands correctly', () => {
      ...
      expect(formatCurrencyShorthand(999999)).toBe('999.9 Thousand Naira');
    });
    ...
    it('formats millions correctly', () => {
      ...
      expect(formatCurrencyShorthand(1590000)).toBe('1.5 Million Naira'); // Truncated
      expect(formatCurrencyShorthand(999999999)).toBe('999.9 Million Naira');
    });
